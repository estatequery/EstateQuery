...
from fake_stake.base_test import ESTATEQUERY_FakeStakeTest

class zEQCwrappedSerialsTest(ESTATEQUERY_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zEQCs..." % DENOM_TO_USE)
