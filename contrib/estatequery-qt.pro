...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/estatequery-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/estatequery-cli.cpp \
           src/estatequery-tx.cpp \
           src/estatequery.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/estatequery.qrc src/qt/estatequery_locale.qrc

TRANSLATIONS += src/qt/locale/estatequery_bg.ts \
                src/qt/locale/estatequery_de.ts \
                src/qt/locale/estatequery_en.ts \
                src/qt/locale/estatequery_es.ts \
                src/qt/locale/estatequery_fi.ts \
                src/qt/locale/estatequery_fr.ts \
                src/qt/locale/estatequery_it.ts \
                src/qt/locale/estatequery_ja.ts \
                src/qt/locale/estatequery_pl.ts \
                src/qt/locale/estatequery_pt.ts \
                src/qt/locale/estatequery_ru.ts \
                src/qt/locale/estatequery_sk.ts \
                src/qt/locale/estatequery_sv.ts \
                src/qt/locale/estatequery_vi.ts \
                src/qt/locale/estatequery_zh_CN.ts \
                src/qt/locale/estatequery_zh_TW.ts
