Contributing to EstateQuery Core
============================

The EstateQuery Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/estatequery-project/estatequery/blob/master/doc/translation_process.md)
...
The following applies to code changes to the EstateQuery Core project, and is not to be
confused with overall EstateQuery Network Protocol consensus changes.

Whether a pull request is merged into EstateQuery Core rests with the project merge
...
Patches that change EstateQuery consensus rules are considerably more involved than
...
Where a patchset proposes to change the EstateQuery consensus, it must have been
...
The project leader is the release manager for each EstateQuery Core release.
