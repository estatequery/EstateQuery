...
#include "key.h"
#include "zeqc/accumulatorcheckpoints.h"
...
BOOST_AUTO_TEST_CASE(deterministic_tests)
{
    ...
    CzEQCWallet zWallet(wallet.strWalletFile);
    ...
    for (int i = 0; i < nTests; i++) {
        ...
        zWallet.GenerateDeterministicZEQC(denom, coin, dMint);
