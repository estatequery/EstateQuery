...
#ifndef ESTATEQUERY_ZEQCTRACKER_H
#define ESTATEQUERY_ZEQCTRACKER_H
...
public:
    CzEQCTracker(std::string strWalletFile);
    ~CzEQCTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzEQCWallet* zEQCWallet = NULL);
...
#endif //ESTATEQUERY_ZEQCTRACKER_H
