...
#ifndef ESTATEQUERY_ZEQCWALLET_H
#define ESTATEQUERY_ZEQCWALLET_H
...
public:
    CzEQCWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZEQC(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZEQC(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
...
#endif //ESTATEQUERY_ZEQCWALLET_H
