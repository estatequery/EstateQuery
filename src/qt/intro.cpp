...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("EstateQuery Core"),
     ...
     * override -datadir in the estatequery.conf file in the default data directory
     * (to be consistent with estatequeryd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
