...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::EQC);
...
// Wallet
    ...
    if (settings.contains("nAnonymize EstateQueryAmount"))
        SoftSetArg("-anonymizeestatequeryamount", settings.value("nAnonymize EstateQueryAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in estatequery.cpp during shotdown to also remove the window positions
