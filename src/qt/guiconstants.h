...
/* EstateQuery GUI -- Size of icons in status bar */
...
/* Transaction list -- TX status decoration - open until date ibpng warning*/
...
#define QAPP_ORG_NAME "ESTATEQUERY"
#define QAPP_ORG_DOMAIN "estatequery.org"
#define QAPP_APP_NAME_DEFAULT "ESTATEQUERY-Qt"
#define QAPP_APP_NAME_TESTNET "ESTATEQUERY-Qt-testnet"
