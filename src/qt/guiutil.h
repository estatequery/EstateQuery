...
/** Utility functions used by the EstateQuery Qt UI.
 */
namespace GUIUtil
{
...
// Render EstateQuery addresses in monospace font
...
// Parse "estatequery:" URI into recipient object, return true on successful parsing
