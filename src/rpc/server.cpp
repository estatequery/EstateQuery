...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop EstateQuery server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "EstateQuery server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* EstateQuery features */
        {"estatequery", "listmasternodes", &listmasternodes, true, true, false},
        {"estatequery", "getmasternodecount", &getmasternodecount, true, true, false},
        {"estatequery", "masternodeconnect", &masternodeconnect, true, true, false},
        {"estatequery", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"estatequery", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"estatequery", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"estatequery", "masternodecurrent", &masternodecurrent, true, true, false},
        {"estatequery", "masternodedebug", &masternodedebug, true, true, false},
        {"estatequery", "startmasternode", &startmasternode, true, true, false},
        {"estatequery", "createmasternodekey", &createmasternodekey, true, true, false},
        {"estatequery", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"estatequery", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"estatequery", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"estatequery", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"estatequery", "getmasternodescores", &getmasternodescores, true, true, false},
        {"estatequery", "preparebudget", &preparebudget, true, true, false},
        {"estatequery", "submitbudget", &submitbudget, true, true, false},
        {"estatequery", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"estatequery", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"estatequery", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"estatequery", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"estatequery", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"estatequery", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"estatequery", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"estatequery", "checkbudgets", &checkbudgets, true, true, false},
        {"estatequery", "mnsync", &mnsync, true, true, false},
        {"estatequery", "spork", &spork, true, true, false},
        {"estatequery", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzeqcseed", &getzeqcseed, false, false, true},
        {"zerocoin", "setzeqcseed", &setzeqcseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzeqc", &searchdzeqc, false, false, true},
        {"zerocoin", "dzeqcstate", &dzeqcstate, false, false, true},
...
{
    return "> estatequery-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:11710/\n";
}
