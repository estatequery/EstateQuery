...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _(" EstateQuery Core estatequery-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               " estatequery-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded estatequery transaction") + "\n" +
                               " estatequery-tx [options] -create [commands]   " + _("Create hex-encoded estatequery transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded estatequery transaction
